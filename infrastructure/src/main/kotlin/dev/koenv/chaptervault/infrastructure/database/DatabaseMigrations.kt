...
object DatabaseMigrations {
    ...
    internal val migrations: List<Migration> = listOf(
        ...
        Migration(2, "fix_series_language_default", listOf(
            "UPDATE series SET language = 'en' WHERE language = '' OR language IS NULL",
        )),
        Migration(3, "create_user_series_status", listOf(
            """
        ...
        Migration(4, "create_notification_targets", listOf(
            """
    ...
    private fun org.jetbrains.exposed.sql.Transaction.runMigrations() {
        ...
        try { exec("ALTER TABLE schema_version ADD COLUMN checksum TEXT") } catch (_: Exception) {}

        val applied: Map<Int, String?> = exec(
...
private fun v1Statements(): List<String> = listOf(
    """
