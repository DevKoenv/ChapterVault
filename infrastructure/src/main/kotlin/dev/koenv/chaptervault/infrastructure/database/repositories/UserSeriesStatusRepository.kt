...
class UserSeriesStatusRepository : ReadingStatusApi {
    ...
    override suspend fun setStatus(userId: Id, seriesId: Id, status: ReadingStatus): Result<Unit> = dbQuery {
    ...
    override suspend fun clearStatus(userId: Id, seriesId: Id): Result<Unit> = dbQuery {
    ...
    override suspend fun getStatus(userId: Id, seriesId: Id): ReadingStatus? = dbQuery {
        UserSeriesStatusTable.selectAll()
            .where {
                (UserSeriesStatusTable.userId eq userId.toString()) and
                    (UserSeriesStatusTable.seriesId eq seriesId.toString())
            }
