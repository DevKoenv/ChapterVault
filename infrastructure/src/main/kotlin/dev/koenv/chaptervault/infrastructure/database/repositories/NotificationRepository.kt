...
class NotificationRepository : NotificationApi {
    ...
    override suspend fun listTargets(): List<NotificationTarget> =
        dbQuery {
    ...
    override suspend fun deleteTarget(id: Id): Result<Unit> =
        dbQuery {
            val deleted =
                NotificationTargetTable.deleteWhere {
    ...
    private fun ResultRow.toTarget() =
        NotificationTarget(
