...
class AuthRoutesTest {
    ...
    private val happyAuth =
        object : AuthApi {
            ...
            override suspend fun authenticate(credentials: Credentials) = Result.Success(fakePrincipal to fakeSession)
    ...
    private val failAuth =
        object : AuthApi {
            ...
            override suspend fun authenticate(credentials: Credentials) = Result.Failure(AppError.Unauthorized())

            override suspend fun validateCredentials(credentials: Credentials) = Result.Failure(AppError.Unauthorized())

            override suspend fun validateSession(token: String) = Result.Failure(AppError.Unauthorized())
