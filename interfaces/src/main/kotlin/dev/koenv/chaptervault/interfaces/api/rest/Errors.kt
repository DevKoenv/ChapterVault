...
suspend fun ApplicationCall.respondBadRequest(message: String) = respond(HttpStatusCode.BadRequest, ErrorResponse("BAD_REQUEST", message))

suspend fun ApplicationCall.respondForbidden() = respond(HttpStatusCode.Forbidden, ErrorResponse("FORBIDDEN", "Forbidden"))
