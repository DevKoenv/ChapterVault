...
private class NotificationTestFixture private constructor(
    ...
    companion object {
        fun build(notificationRegistry: NotificationChannelRegistry, tempDir: Path): NotificationTestFixture {
...
private class ChannelRegisteringExtension(override val id: String) : Extension {
...
private fun simpleNotificationTestConnectorRegistry(): dev.koenv.chaptervault.kernel.connector.ConnectorRegistry {
    ...
    return object : dev.koenv.chaptervault.kernel.connector.ConnectorRegistry {
        override fun register(connector: dev.koenv.chaptervault.kernel.connector.Connector) { entries[connector.id] = connector }
