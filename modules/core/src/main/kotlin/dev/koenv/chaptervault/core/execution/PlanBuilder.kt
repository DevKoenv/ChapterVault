...
class PlanBuilder {
    ...
    fun fetchHtml(
        ...
        val instruction = FetchHtml(id, url, headers, referer, timeout)
    ...
    fun fetchJson(
        ...
        val instruction = FetchJson(id, url, headers, referer, timeout)
        instructions.add(instruction)
        return InstructionRef(id)
    }
    ...
    fun fetchBytes(
        ...
        val instruction = FetchBytes(id, url, headers, referer, timeout)
        instructions.add(instruction)
        return InstructionRef(id)
    }
    ...
    fun postForm(
        ...
        val instruction = PostForm(id, url, formData, headers, timeout)
        instructions.add(instruction)
        return InstructionRef(id)
    }
    ...
    fun postJson(
        ...
        val instruction = PostJson(id, url, jsonBody, headers, timeout)
        instructions.add(instruction)
        return InstructionRef(id)
    }
    ...
    fun fetchDocument(
        ...
        val instruction = FetchDocument(id, url, headers, referer, timeout)
        instructions.add(instruction)
        return InstructionRef(id)
    }
    ...
    fun extractData(
        ...
        specBuilder.spec()
        val instruction = ExtractData(id, url, specBuilder.build(), headers, referer, timeout)
        instructions.add(instruction)
        return InstructionRef(id)
    }
...
class BrowserPlanBuilder(private val nextId: (String) -> String) {
    ...
    fun navigate(
        ...
        instructions.add(BrowserNavigate(id, url, waitUntil, timeout))
        return InstructionRef(id)
    }
    ...
    fun downloadFile(
        ...
        instructions.add(BrowserDownloadFile(id, url, referer))
        return InstructionRef(id)
    }
...
class BulkDownloadBuilder {
    ...
    fun item(
        ...
        items.add(DownloadItem(id, url, headers, referer))
    }
